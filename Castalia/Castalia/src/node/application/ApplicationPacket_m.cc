...
void ApplicationPacket::copy(const ApplicationPacket& other)
{
    ...
    this->numAgg_var = other.numAgg_var;
    this->aggVec_var = other.aggVec_var;
}
...
void ApplicationPacket::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->numAgg_var);
    doPacking(b,this->aggVec_var);
}
...
void ApplicationPacket::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->numAgg_var);
    doUnpacking(b,this->aggVec_var);
}
...
int ApplicationPacket::getNumAgg() const
{
    return numAgg_var;
}

void ApplicationPacket::setNumAgg(int numAgg)
{
    this->numAgg_var = numAgg;
}

IntVector& ApplicationPacket::getAggVec()
{
    return aggVec_var;
}

void ApplicationPacket::setAggVec(const IntVector& aggVec)
{
    this->aggVec_var = aggVec;
}
...
int ApplicationPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "numAgg")==0) return base+4;
    if (fieldName[0]=='a' && strcmp(fieldName, "aggVec")==0) return base+5;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string ApplicationPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return long2string(pp->getNumAgg());
        case 5: {std::stringstream out; out << pp->getAggVec(); return out.str();}
        default: return "";
    }
}
...
bool ApplicationPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setNumAgg(string2long(value)); return true;
        default: return false;
    }
}
...
void *ApplicationPacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return (void *)(&pp->getAggVec()); break;
        default: return NULL;
    }
}
