...
/**
 * Struct generated from src/node/application/ApplicationPacket.msg:26 by nedtool.
 */
...
/**
 * Class generated from <tt>src/node/application/ApplicationPacket.msg:38</tt> by nedtool.
 * <pre>
...
class ApplicationPacket : public ::cPacket
{
  ...
  public:
    ...
    virtual int getNumAgg() const;
    virtual void setNumAgg(int numAgg);
    virtual IntVector& getAggVec();
    virtual const IntVector& getAggVec() const {return const_cast<ApplicationPacket*>(this)->getAggVec();}
    virtual void setAggVec(const IntVector& aggVec);
};
