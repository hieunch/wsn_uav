...
public:
  ...
  enum NumParam {
    ...
    PolishTime CPXDEPRECATEDENUMVAL(12090000) = CPX_PARAM_POLISHTIME,
    ...
    RampupDettimeLim CPXDEPRECATEDENUMVAL(12090000) = CPX_PARAM_RAMPUPDETTILIM,
    RampupWalltimeLim CPXDEPRECATEDENUMVAL(12090000) = CPX_PARAM_RAMPUPTILIM,
  ...
  enum IntParam {
    ...
    RampupDuration CPXDEPRECATEDENUMVAL(12090000) = CPX_PARAM_RAMPUPDURATION,
