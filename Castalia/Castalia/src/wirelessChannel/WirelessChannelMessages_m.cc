...
int WirelessChannelSignalBegin::getDestID() const
{
    return destID_var;
}

void WirelessChannelSignalBegin::setDestID(int destID)
{
...
int WirelessChannelSignalBeginDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "destID")==0) return base+6;
...
std::string WirelessChannelSignalBeginDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 6: return long2string(pp->getDestID());
        default: return "";
    }
}
...
bool WirelessChannelSignalBeginDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 6: pp->setDestID(string2long(value)); return true;
...
int WirelessChannelSignalEnd::getDestID() const
{
    return destID_var;
}

void WirelessChannelSignalEnd::setDestID(int destID)
{
    this->destID_var = destID;
}
